...
def index(request):
	...
	if request.method == 'POST':
		...
		form = ContactForm()
	return render(request, 'getHelp/index.html', {'form': form, 'dark': dark, 'profile_picture':  user_profile.profile_picture if user_profile and user_profile.profile_picture else None})
